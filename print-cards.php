...
$stmt = $pdo->prepare("SELECT * FROM siswa WHERE id IN ($placeholders) ORDER BY nama_lengkap");
...
<body>
    ...
    <div class="cards-container">
        <?php foreach ($siswaList as $siswa):
            $qrApiUrl = "https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=" . urlencode($siswa['nomor_induk']);
            ?>
            <div class="id-card">
