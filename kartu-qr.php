...
<div class="main-content">
    <div class="mb-3 no-print">
        <a href="admin/santri.php" class="btn btn-light border"><i class="fas fa-arrow-left me-1"></i> Kembali</a>
    </div>
            ...
            <div class="id-card">
                ...
                <div class="card-body">
                    ...
                    <div class="info-section">
                        ...
                        <div class="student-nis"><?= e($siswa['nisn'] ?? '-') ?></div>
...
<script>
    function downloadCard() {
        ...
        html2canvas(card, {
            ...
            link.download = 'Kartu_<?= e($siswa['nisn'] ?? $siswa['id']) ?>_<?= preg_replace('/[^a-zA-Z0-9]/', '_', $siswa['nama_lengkap']) ?>.png';
